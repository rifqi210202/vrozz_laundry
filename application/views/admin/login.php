              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4 font-weight-bolder">Selamat Datang Admin !</h1>
                  </div>
                  <form class="user" method="POST" action="<?=base_url('admin/auth/login')?>"> 
                    <?=$this->session->flashdata('flash') ?>
                    <div class="form-group">
                      <label class="ml-3 font-weight-bold">Nama Pengguna</label>
                    ...
                    <div class="form-group">
                      <label class="ml-3 font-weight-bold">Kata Sandi</label>
                    ...
                    <div class="text-center mt-3">
                      <a href="<?= base_url() ?>" class="btn btn-link">Kembali ke Beranda</a>
                    </div>
                  </form>
                </div>
              </div>
