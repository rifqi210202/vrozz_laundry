<div class="container-fluid">
  <!-- Page Heading -->
  <h1 class="h3 mb-5 text-gray-800">Overview Data <?=$section?> Paketan</h1>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title font-weight-bold">Pilih Data Sepatu</h5>
          ...
          <table class="table table-bordered table-responsive" id="dataTable">
            <thead>
              <tr>
                ...
                <th style="width: 500px">Jenis Sepatu</th>
