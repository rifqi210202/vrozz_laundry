...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top p-3 shadow">
    <div class="container">
      <a class="navbar-brand font-weight-bold title" href="<?=base_url('admin')?>">Vroz Clean Shoes</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 h-100 text-center text-lg-left my-auto text-white">
          ...
          <p class="text-white small mb-4 mb-lg-0">&copy; DZ Laundry 2023. AM-Dev All Rights Reserved.</p>
        </div>
