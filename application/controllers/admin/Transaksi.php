...
class Transaksi extends CI_Controller{
	...
	public function cetak($id=null){
		...
		$pdf->Cell(190,7,'Struk DZ Laundry' ,0,0,'C');
    ...
    $pdf->Cell(125, 6, '*Note: untuk pengecekan progres laundry di www.laundry.com dan masukkan no struk anda.', 0, 1);

    $pdf->SetFont('Arial','',10);
    $pdf->Cell(125, 6, 'Hormat Kami,', 0, 1);
    $pdf->Cell(125, 6, '' . $this->session->userdata('name'), 0, 1);
